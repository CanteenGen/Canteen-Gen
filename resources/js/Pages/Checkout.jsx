...
export default function Checkout({ items, total }) {
  ...
  const handleCreateOrder = () => {
    router.post('/create-order', {
      ...
      protection,
      discount,
      total: subtotal + protection - discount
    })
  }

  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-8 pb-24"> {/* Added pb-24 for bottom padding */}
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t flex justify-between font-semibold">
                    ...
                    <span>Rp{(subtotal + protection - discount).toLocaleString()}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 shadow-md"> {/* Added shadow-md for visual separation */}
          <div className="container mx-auto flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Total:</p>
              <p className="font-semibold">Rp{(subtotal + protection - discount).toLocaleString()}</p>
            </div>
